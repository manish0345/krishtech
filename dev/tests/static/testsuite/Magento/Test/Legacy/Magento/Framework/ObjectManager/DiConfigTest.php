...
class DiConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Scan the specified events.xml file and assert that it has no obsolete nodes
     *
     * @param string $file
     */
    ...
    /**
     * Scan the specified events.xml file and assert that it has no directly configured CommandList class
     *
     * @param string $file
     */
