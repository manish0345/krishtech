	...
	$.jstree.plugin("types", {
				...
				.bind("init.jstree", $.proxy(function () {
						...
						$.each(types, function (i, tp) {
							...
							if( tp.icon.image || tp.icon.position) {
								if(i == "local.xml")	{ icons_css += '.jstree-' + _this.get_index() + ' a > .jstree-icon { '; }
						...
						if($.inArray(data.func, this.data.types.attach_to) !== -1) {
							...
							if(
								(
									...
									(s["local.xml"] && typeof s["local.xml"][data.func] !== "undefined")
					...
					.bind("load_node.jstree set_type.jstree", $.proxy(function (e, data) {
							...
							$.each(s.types, function (i, tp) {
								if(tp.icon && (tp.icon.image || tp.icon.position)) {
									c = i === "local.xml" ? r.find("li > a > .jstree-icon") : r.find("li[" + s.type_attr + "='" + i + "'] > a > .jstree-icon");
		...
		_fn : {
			...
			_get_type : function (obj) {
				obj = this._get_node(obj);
				return (!obj || !obj.length) ? false : obj.attr(this._get_settings().types.type_attr) || "local.xml";
			},
			...
			_check : function (rule, obj, opts) {
				...
				if(obj === -1) {
					...
					else if(!!s.types["local.xml"] && typeof s.types["local.xml"][rule] !== "undefined") { v = s.types["local.xml"][rule]; }
				}
